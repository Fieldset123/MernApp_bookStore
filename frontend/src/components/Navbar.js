...
//dark theme light theme handling
const[theme,setTheme]=useState(localStorage.getItem("theme")?localStorage.getItem("theme"):"light")
const element=document.documentElement;  //targeting root element of browser
//click krne pe effect dikhana hai so use useEffect
useEffect(()=>{
 if(theme==="dark"){
...
//ye useffect theme wala button click krne pe chlna chahiye
...
//handling the shadow which appears when we scroll down
            ...
            <div className="navbar">
                ...
                <div className="navbar-end">
                    ...
                    <div className="hidden md:block">
                        <label className="border rounded-md py-2 px-3 mx-2 flex items-center gap-2">
                    ...
                    <div>
                        <label className="swap swap-rotate">
                            ...
                            {/* sun icon */}
                            <svg className="swap-off fill-current w-8 h-8" 
